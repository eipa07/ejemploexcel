		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Portal licitacion GenommaLab",
									"targetURL": "#genommalabportaltendering-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"genommalabportaltendering-display": {
								"semanticObject": "genommalabportaltendering",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=genommalab.portal.tendering",
									"url": sap.ui.require.toUrl("genommalab/portal/tendering")
								}
							}
						}
					}
